...
from moderate_boll_strategy_v5 import ModerateBollStrategyV5
...
def test_and_visualize():
    ...
    """
    print("=" * 100)
    print("修正后的适中布林带策略V5 - 回测与可视化")
    print("=" * 100)
    print()
    
    # 创建输出文件夹
    output_dir = 'results/moderate_boll_v5'
    ...
    # 初始化策略
    strategy = ModerateBollStrategyV5(
        period=20,
        std_dev=2,
        min_uptrend_days=20,
    ...
    for symbol in test_symbols:
        ...
        try:
            ...
            # 计算年化收益
            years = len(data) / 252  # 日K数据，一年约252个交易日
...
def visualize_trades(symbol, data, trades, output_dir):
    ...
    fig.suptitle(f'{symbol} - 修正后适中布林带策略V5交易信号', fontsize=16, fontweight='bold')
