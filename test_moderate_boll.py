...
from moderate_boll_strategy import ModerateBollStrategy
...
def test_and_visualize():
    ...
    # 创建输出文件夹
    output_dir = 'results/moderate_boll'
...
def visualize_trades(symbol, data, trades, output_dir):
    ...
    fig.suptitle(f'{symbol} - 适中布林带策略交易信号', fontsize=16, fontweight='bold')
