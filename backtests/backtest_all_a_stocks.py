...
def backtest_all_a_stocks():
    ...
    """
    print("=" * 100)
    print("A股日线布林带策略回测（20年数据）")
    print("=" * 100)
    print()
    
    # 创建输出文件夹
    output_dir = 'results/a_stock_daily_boll'
    ...
    # 初始化策略
    strategy = DailyBollingerStrategy()
    ...
    for i, symbol in enumerate(symbols, 1):
        ...
        try:
            ...
            print(f"  策略年化收益: {result['annualized_return_pct']:.2f}%")
