"""
A鑲℃渶杩?骞寸儹闂ㄨ偂绁ㄧ紶璁哄疄鏃舵柟妗堝洖娴?- 鍙娇鐢ㄧ涓€绫讳拱鍗栫偣
"""
import pandas as pd
import numpy as np
import os
...
def main():
    print("=" * 100)
    print("A鑲＄儹闂ㄨ偂绁ㄧ紶璁哄疄鏃舵柟妗堝洖娴?- 浠呯涓€绫讳拱鍗栫偣 (杩?骞?")
    print("=" * 100)
    print()
