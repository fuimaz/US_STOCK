...
2. 买入时机是在上行期，出现股价跌破boll下轨，且间隔2周以上的2次反弹都没有上穿boll带上轨，第三次或者之后的反弹穿过中轨后，回落到中轨之下买入
...
class ModerateBollStrategyV2(BaseStrategy):
    ...
    def generate_signals(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        for i in range(len(df)):
            ...
            # 5. 买入信号：在上行期，出现股价跌破boll下轨，且间隔2周以上的2次反弹都没有上穿boll带上轨，
            ...
            # 6. 卖出信号：在上行期出现股价间隔2周以上2次跌破boll下轨后，继续上涨到boll带上轨时卖出
