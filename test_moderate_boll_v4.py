...
def test_and_visualize():
    ...
    """
    print("=" * 100)
    print("调整后的适中布林带策略V4（正确版本）测试与可视化")
    print("=" * 100)
    print()
    
    # 创建输出文件夹
    output_dir = 'results/moderate_boll_v4'
...
def visualize_trades(symbol, data, trades, output_dir):
    ...
    fig.suptitle(f'{symbol} - 调整后适中布林带策略V4（正确版本）交易信号', fontsize=16, fontweight='bold')
